...
class Display : public properties::BoolProperty
{
  Q_OBJECT
...
public:
   ...
   */
  virtual void setStatus(properties::StatusProperty::Level level, const QString& name, const QString& text);
   ...
   * This is thread-safe.
   */
  void setStatusStd(properties::StatusProperty::Level level, const std::string& name, const std::string& text);
