...
class Odometry final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::geometry_msgs::PoseWithCovariance* release_pose();
  ...
  PROTOBUF_NODISCARD ::geometry_msgs::TwistWithCovariance* release_twist();
...
inline ::geometry_msgs::PoseWithCovariance* Odometry::_internal_mutable_pose() {
  ...
  if (pose_ == nullptr) {
    auto* p = CreateMaybeMessage<::geometry_msgs::PoseWithCovariance>(GetArenaForAllocation());
    pose_ = p;
  }
  return pose_;
}
inline ::geometry_msgs::PoseWithCovariance* Odometry::mutable_pose() {
  ::geometry_msgs::PoseWithCovariance* _msg = _internal_mutable_pose();
...
inline ::geometry_msgs::TwistWithCovariance* Odometry::_internal_mutable_twist() {
  ...
  if (twist_ == nullptr) {
    auto* p = CreateMaybeMessage<::geometry_msgs::TwistWithCovariance>(GetArenaForAllocation());
    twist_ = p;
  }
  return twist_;
}
inline ::geometry_msgs::TwistWithCovariance* Odometry::mutable_twist() {
  ::geometry_msgs::TwistWithCovariance* _msg = _internal_mutable_twist();
