...
#ifndef GOOGLE_PROTOBUF_INCLUDED_trajectory_5fmsgs_2fjoint_5ftrajectory_5fpoint_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_trajectory_5fmsgs_2fjoint_5ftrajectory_5fpoint_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_trajectory_5fmsgs_2fjoint_5ftrajectory_5fpoint_2eproto
...
struct TableStruct_trajectory_5fmsgs_2fjoint_5ftrajectory_5fpoint_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_trajectory_5fmsgs_2fjoint_5ftrajectory_5fpoint_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::trajectory_msgs::JointTrajectoryPoint* Arena::CreateMaybeMessage<::trajectory_msgs::JointTrajectoryPoint>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace trajectory_msgs {
...
class JointTrajectoryPoint final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:trajectory_msgs.JointTrajectoryPoint) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:trajectory_msgs.JointTrajectoryPoint)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_trajectory_5fmsgs_2fjoint_5ftrajectory_5fpoint_2eproto;
};
// ===================================================================
...
inline double JointTrajectoryPoint::positions(int index) const {
  // @@protoc_insertion_point(field_get:trajectory_msgs.JointTrajectoryPoint.positions)
...
inline void JointTrajectoryPoint::set_positions(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:trajectory_msgs.JointTrajectoryPoint.positions)
}
...
inline void JointTrajectoryPoint::add_positions(double value) {
  ...
  // @@protoc_insertion_point(field_add:trajectory_msgs.JointTrajectoryPoint.positions)
}
...
JointTrajectoryPoint::positions() const {
  // @@protoc_insertion_point(field_list:trajectory_msgs.JointTrajectoryPoint.positions)
...
JointTrajectoryPoint::mutable_positions() {
  // @@protoc_insertion_point(field_mutable_list:trajectory_msgs.JointTrajectoryPoint.positions)
...
inline double JointTrajectoryPoint::velocities(int index) const {
  // @@protoc_insertion_point(field_get:trajectory_msgs.JointTrajectoryPoint.velocities)
...
inline void JointTrajectoryPoint::set_velocities(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:trajectory_msgs.JointTrajectoryPoint.velocities)
}
...
inline void JointTrajectoryPoint::add_velocities(double value) {
  ...
  // @@protoc_insertion_point(field_add:trajectory_msgs.JointTrajectoryPoint.velocities)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
JointTrajectoryPoint::velocities() const {
  // @@protoc_insertion_point(field_list:trajectory_msgs.JointTrajectoryPoint.velocities)
...
JointTrajectoryPoint::mutable_velocities() {
  // @@protoc_insertion_point(field_mutable_list:trajectory_msgs.JointTrajectoryPoint.velocities)
...
inline double JointTrajectoryPoint::accelerations(int index) const {
  // @@protoc_insertion_point(field_get:trajectory_msgs.JointTrajectoryPoint.accelerations)
...
inline void JointTrajectoryPoint::set_accelerations(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:trajectory_msgs.JointTrajectoryPoint.accelerations)
}
...
inline void JointTrajectoryPoint::add_accelerations(double value) {
  ...
  // @@protoc_insertion_point(field_add:trajectory_msgs.JointTrajectoryPoint.accelerations)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
JointTrajectoryPoint::accelerations() const {
  // @@protoc_insertion_point(field_list:trajectory_msgs.JointTrajectoryPoint.accelerations)
...
JointTrajectoryPoint::mutable_accelerations() {
  // @@protoc_insertion_point(field_mutable_list:trajectory_msgs.JointTrajectoryPoint.accelerations)
...
inline double JointTrajectoryPoint::effort(int index) const {
  // @@protoc_insertion_point(field_get:trajectory_msgs.JointTrajectoryPoint.effort)
  return _internal_effort(index);
}
inline void JointTrajectoryPoint::set_effort(int index, double value) {
  effort_.Set(index, value);
  // @@protoc_insertion_point(field_set:trajectory_msgs.JointTrajectoryPoint.effort)
}
...
inline void JointTrajectoryPoint::add_effort(double value) {
  ...
  // @@protoc_insertion_point(field_add:trajectory_msgs.JointTrajectoryPoint.effort)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
JointTrajectoryPoint::effort() const {
  // @@protoc_insertion_point(field_list:trajectory_msgs.JointTrajectoryPoint.effort)
...
JointTrajectoryPoint::mutable_effort() {
  // @@protoc_insertion_point(field_mutable_list:trajectory_msgs.JointTrajectoryPoint.effort)
...
inline const ::builtin_interfaces::Duration& JointTrajectoryPoint::_internal_time_from_start() const {
...
inline const ::builtin_interfaces::Duration& JointTrajectoryPoint::time_from_start() const {
  // @@protoc_insertion_point(field_get:trajectory_msgs.JointTrajectoryPoint.time_from_start)
...
inline void JointTrajectoryPoint::unsafe_arena_set_allocated_time_from_start(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:trajectory_msgs.JointTrajectoryPoint.time_from_start)
}
inline ::builtin_interfaces::Duration* JointTrajectoryPoint::release_time_from_start() {
...
inline ::builtin_interfaces::Duration* JointTrajectoryPoint::unsafe_arena_release_time_from_start() {
  // @@protoc_insertion_point(field_release:trajectory_msgs.JointTrajectoryPoint.time_from_start)
  
  ::builtin_interfaces::Duration* temp = time_from_start_;
  time_from_start_ = nullptr;
  return temp;
}
inline ::builtin_interfaces::Duration* JointTrajectoryPoint::_internal_mutable_time_from_start() {
...
inline ::builtin_interfaces::Duration* JointTrajectoryPoint::mutable_time_from_start() {
  ::builtin_interfaces::Duration* _msg = _internal_mutable_time_from_start();
  // @@protoc_insertion_point(field_mutable:trajectory_msgs.JointTrajectoryPoint.time_from_start)
  return _msg;
}
inline void JointTrajectoryPoint::set_allocated_time_from_start(::builtin_interfaces::Duration* time_from_start) {
  ...
  time_from_start_ = time_from_start;
  // @@protoc_insertion_point(field_set_allocated:trajectory_msgs.JointTrajectoryPoint.time_from_start)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_trajectory_5fmsgs_2fjoint_5ftrajectory_5fpoint_2eproto
