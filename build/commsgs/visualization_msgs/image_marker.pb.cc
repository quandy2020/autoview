...
#include "visualization_msgs/image_marker.pb.h"
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_visualization_5fmsgs_2fimage_5fmarker_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_visualization_5fmsgs_2fimage_5fmarker_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_visualization_5fmsgs_2fimage_5fmarker_2eproto = nullptr;

const uint32_t TableStruct_visualization_5fmsgs_2fimage_5fmarker_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, header_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, ns_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, id_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, type_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, action_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, position_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, scale_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, outline_color_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, filled_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, fill_color_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, lifetime_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, points_),
  PROTOBUF_FIELD_OFFSET(::visualization_msgs::ImageMarker, outline_colors_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::visualization_msgs::ImageMarker)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::visualization_msgs::_ImageMarker_default_instance_),
};

const char descriptor_table_protodef_visualization_5fmsgs_2fimage_5fmarker_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n%visualization_msgs/image_marker.proto\022"
  "\022visualization_msgs\032\025std_msgs/header.pro"
  "to\032\031std_msgs/color_rgba.proto\032!builtin_i"
  "nterfaces/duration.proto\032\031geometry_msgs/"
  "point.proto\"\204\003\n\013ImageMarker\022 \n\006header\030\001 "
  "\001(\0132\020.std_msgs.Header\022\n\n\002ns\030\002 \001(\t\022\n\n\002id\030"
  "\003 \001(\005\022\014\n\004type\030\004 \001(\005\022\016\n\006action\030\005 \001(\005\022&\n\010p"
  "osition\030\006 \001(\0132\024.geometry_msgs.Point\022\r\n\005s"
  "cale\030\007 \001(\002\022*\n\routline_color\030\010 \001(\0132\023.std_"
  "msgs.ColorRGBA\022\016\n\006filled\030\t \001(\r\022\'\n\nfill_c"
  "olor\030\n \001(\0132\023.std_msgs.ColorRGBA\022.\n\010lifet"
  "ime\030\013 \001(\0132\034.builtin_interfaces.Duration\022"
  "$\n\006points\030\014 \003(\0132\024.geometry_msgs.Point\022+\n"
  "\016outline_colors\030\r \003(\0132\023.std_msgs.ColorRG"
  "BAb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto_deps[4] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto = {
  false, false, 570, descriptor_table_protodef_visualization_5fmsgs_2fimage_5fmarker_2eproto, "visualization_msgs/image_marker.proto", 
  &descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto_once, descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto_deps, 4, 1,
  schemas, file_default_instances, TableStruct_visualization_5fmsgs_2fimage_5fmarker_2eproto::offsets,
  file_level_metadata_visualization_5fmsgs_2fimage_5fmarker_2eproto, file_level_enum_descriptors_visualization_5fmsgs_2fimage_5fmarker_2eproto, file_level_service_descriptors_visualization_5fmsgs_2fimage_5fmarker_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto_getter() {
  return &descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_visualization_5fmsgs_2fimage_5fmarker_2eproto(&descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto);
namespace visualization_msgs {
...
class ImageMarker::_Internal {
 public:
  static const ::std_msgs::Header& header(const ImageMarker* msg);
  static const ::geometry_msgs::Point& position(const ImageMarker* msg);
  static const ::std_msgs::ColorRGBA& outline_color(const ImageMarker* msg);
  static const ::std_msgs::ColorRGBA& fill_color(const ImageMarker* msg);
  static const ::builtin_interfaces::Duration& lifetime(const ImageMarker* msg);
};
...
ImageMarker::ImageMarker(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:visualization_msgs.ImageMarker)
}
ImageMarker::ImageMarker(const ImageMarker& from)
  ...
  if (from._internal_has_outline_color()) {
    outline_color_ = new ::std_msgs::ColorRGBA(*from.outline_color_);
  } else {
    outline_color_ = nullptr;
  }
  if (from._internal_has_fill_color()) {
    fill_color_ = new ::std_msgs::ColorRGBA(*from.fill_color_);
  } else {
    fill_color_ = nullptr;
  }
  ...
  // @@protoc_insertion_point(copy_constructor:visualization_msgs.ImageMarker)
}
...
ImageMarker::~ImageMarker() {
  // @@protoc_insertion_point(destructor:visualization_msgs.ImageMarker)
...
// @@protoc_insertion_point(message_clear_start:visualization_msgs.ImageMarker)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "visualization_msgs.ImageMarker.ns"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ImageMarker::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:visualization_msgs.ImageMarker)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_ns().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "visualization_msgs.ImageMarker.ns");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:visualization_msgs.ImageMarker)
  return target;
}

size_t ImageMarker::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:visualization_msgs.ImageMarker)
  size_t total_size = 0;
  ...
  // uint32 filled = 9;
  if (this->_internal_filled() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_filled());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:visualization_msgs.ImageMarker)
  ...
  if (from._internal_has_outline_color()) {
    _internal_mutable_outline_color()->::std_msgs::ColorRGBA::MergeFrom(from._internal_outline_color());
  }
  if (from._internal_has_fill_color()) {
    _internal_mutable_fill_color()->::std_msgs::ColorRGBA::MergeFrom(from._internal_fill_color());
  }
  if (from._internal_has_lifetime()) {
...
// @@protoc_insertion_point(class_specific_copy_from_start:visualization_msgs.ImageMarker)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ImageMarker::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto_getter, &descriptor_table_visualization_5fmsgs_2fimage_5fmarker_2eproto_once,
      file_level_metadata_visualization_5fmsgs_2fimage_5fmarker_2eproto[0]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace visualization_msgs
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::visualization_msgs::ImageMarker* Arena::CreateMaybeMessage< ::visualization_msgs::ImageMarker >(Arena* arena) {
  return Arena::CreateMessageInternal< ::visualization_msgs::ImageMarker >(arena);
}
