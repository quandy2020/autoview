...
#ifndef GOOGLE_PROTOBUF_INCLUDED_visualization_5fmsgs_2fmenu_5fentry_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_visualization_5fmsgs_2fmenu_5fentry_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_visualization_5fmsgs_2fmenu_5fentry_2eproto
...
struct TableStruct_visualization_5fmsgs_2fmenu_5fentry_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_visualization_5fmsgs_2fmenu_5fentry_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::visualization_msgs::MenuEntry* Arena::CreateMaybeMessage<::visualization_msgs::MenuEntry>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace visualization_msgs {
...
class MenuEntry final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:visualization_msgs.MenuEntry) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:visualization_msgs.MenuEntry)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_visualization_5fmsgs_2fmenu_5fentry_2eproto;
};
// ===================================================================
...
inline uint32_t MenuEntry::id() const {
  // @@protoc_insertion_point(field_get:visualization_msgs.MenuEntry.id)
  return _internal_id();
}
...
inline void MenuEntry::set_id(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:visualization_msgs.MenuEntry.id)
}
...
inline uint32_t MenuEntry::parent_id() const {
  // @@protoc_insertion_point(field_get:visualization_msgs.MenuEntry.parent_id)
...
inline void MenuEntry::set_parent_id(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:visualization_msgs.MenuEntry.parent_id)
}
...
inline const std::string& MenuEntry::title() const {
  // @@protoc_insertion_point(field_get:visualization_msgs.MenuEntry.title)
...
void MenuEntry::set_title(ArgT0&& arg0, ArgT... args) {
 ...
 title_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:visualization_msgs.MenuEntry.title)
}
inline std::string* MenuEntry::mutable_title() {
  std::string* _s = _internal_mutable_title();
  // @@protoc_insertion_point(field_mutable:visualization_msgs.MenuEntry.title)
  return _s;
}
...
inline std::string* MenuEntry::release_title() {
  // @@protoc_insertion_point(field_release:visualization_msgs.MenuEntry.title)
...
inline void MenuEntry::set_allocated_title(std::string* title) {
  ...
  // @@protoc_insertion_point(field_set_allocated:visualization_msgs.MenuEntry.title)
}
...
inline const std::string& MenuEntry::command() const {
  // @@protoc_insertion_point(field_get:visualization_msgs.MenuEntry.command)
...
void MenuEntry::set_command(ArgT0&& arg0, ArgT... args) {
 ...
 command_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:visualization_msgs.MenuEntry.command)
}
inline std::string* MenuEntry::mutable_command() {
  std::string* _s = _internal_mutable_command();
  // @@protoc_insertion_point(field_mutable:visualization_msgs.MenuEntry.command)
  return _s;
}
...
inline std::string* MenuEntry::release_command() {
  // @@protoc_insertion_point(field_release:visualization_msgs.MenuEntry.command)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:visualization_msgs.MenuEntry.command)
}
...
inline uint32_t MenuEntry::command_type() const {
  // @@protoc_insertion_point(field_get:visualization_msgs.MenuEntry.command_type)
...
inline void MenuEntry::set_command_type(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:visualization_msgs.MenuEntry.command_type)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_visualization_5fmsgs_2fmenu_5fentry_2eproto
