...
#ifndef GOOGLE_PROTOBUF_INCLUDED_shape_5fmsgs_2fplane_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_shape_5fmsgs_2fplane_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_shape_5fmsgs_2fplane_2eproto
...
struct TableStruct_shape_5fmsgs_2fplane_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_shape_5fmsgs_2fplane_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::shape_msgs::Plane* Arena::CreateMaybeMessage<::shape_msgs::Plane>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace shape_msgs {
...
class Plane final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:shape_msgs.Plane) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:shape_msgs.Plane)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_shape_5fmsgs_2fplane_2eproto;
};
// ===================================================================
...
inline double Plane::coef(int index) const {
  // @@protoc_insertion_point(field_get:shape_msgs.Plane.coef)
  return _internal_coef(index);
}
inline void Plane::set_coef(int index, double value) {
  coef_.Set(index, value);
  // @@protoc_insertion_point(field_set:shape_msgs.Plane.coef)
}
...
inline void Plane::add_coef(double value) {
  ...
  // @@protoc_insertion_point(field_add:shape_msgs.Plane.coef)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
Plane::coef() const {
  // @@protoc_insertion_point(field_list:shape_msgs.Plane.coef)
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
Plane::mutable_coef() {
  // @@protoc_insertion_point(field_mutable_list:shape_msgs.Plane.coef)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_shape_5fmsgs_2fplane_2eproto
