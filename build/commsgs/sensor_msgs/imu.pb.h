...
class Imu final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::geometry_msgs::Vector3* release_angular_velocity();
  ...
  PROTOBUF_NODISCARD ::geometry_msgs::Vector3* release_linear_acceleration();
...
inline ::geometry_msgs::Vector3* Imu::mutable_angular_velocity() {
  ::geometry_msgs::Vector3* _msg = _internal_mutable_angular_velocity();
...
inline ::geometry_msgs::Vector3* Imu::mutable_linear_acceleration() {
  ::geometry_msgs::Vector3* _msg = _internal_mutable_linear_acceleration();
