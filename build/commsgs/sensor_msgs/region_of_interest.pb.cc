...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto = nullptr;

const uint32_t TableStruct_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::RegionOfInterest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::RegionOfInterest, x_offset_),
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::RegionOfInterest, y_offset_),
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::RegionOfInterest, height_),
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::RegionOfInterest, width_),
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::RegionOfInterest, do_rectify_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::sensor_msgs::RegionOfInterest)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::sensor_msgs::_RegionOfInterest_default_instance_),
};

const char descriptor_table_protodef_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n$sensor_msgs/region_of_interest.proto\022\013"
  "sensor_msgs\"i\n\020RegionOfInterest\022\020\n\010x_off"
  "set\030\001 \001(\r\022\020\n\010y_offset\030\002 \001(\r\022\016\n\006height\030\003 "
  "\001(\r\022\r\n\005width\030\004 \001(\r\022\022\n\ndo_rectify\030\005 \001(\010b\006"
  "proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto = {
  false, false, 166, descriptor_table_protodef_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto, "sensor_msgs/region_of_interest.proto", 
  &descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto::offsets,
  file_level_metadata_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto, file_level_enum_descriptors_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto, file_level_service_descriptors_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto_getter() {
  return &descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto(&descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto);
namespace sensor_msgs {
...
RegionOfInterest::RegionOfInterest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:sensor_msgs.RegionOfInterest)
}
RegionOfInterest::RegionOfInterest(const RegionOfInterest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:sensor_msgs.RegionOfInterest)
}
...
RegionOfInterest::~RegionOfInterest() {
  // @@protoc_insertion_point(destructor:sensor_msgs.RegionOfInterest)
...
// @@protoc_insertion_point(message_clear_start:sensor_msgs.RegionOfInterest)
...
uint8_t* RegionOfInterest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:sensor_msgs.RegionOfInterest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sensor_msgs.RegionOfInterest)
  return target;
}

size_t RegionOfInterest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sensor_msgs.RegionOfInterest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:sensor_msgs.RegionOfInterest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:sensor_msgs.RegionOfInterest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata RegionOfInterest::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto_getter, &descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto_once,
      file_level_metadata_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto[0]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace sensor_msgs
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::sensor_msgs::RegionOfInterest* Arena::CreateMaybeMessage< ::sensor_msgs::RegionOfInterest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::sensor_msgs::RegionOfInterest >(arena);
}
