...
#ifndef GOOGLE_PROTOBUF_INCLUDED_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto
...
struct TableStruct_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::sensor_msgs::RegionOfInterest* Arena::CreateMaybeMessage<::sensor_msgs::RegionOfInterest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace sensor_msgs {
...
class RegionOfInterest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sensor_msgs.RegionOfInterest) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto;
};
// ===================================================================
...
inline uint32_t RegionOfInterest::x_offset() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.RegionOfInterest.x_offset)
...
inline void RegionOfInterest::set_x_offset(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:sensor_msgs.RegionOfInterest.x_offset)
}
...
inline uint32_t RegionOfInterest::y_offset() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.RegionOfInterest.y_offset)
...
inline void RegionOfInterest::set_y_offset(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:sensor_msgs.RegionOfInterest.y_offset)
}
...
inline uint32_t RegionOfInterest::height() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.RegionOfInterest.height)
...
inline void RegionOfInterest::set_height(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:sensor_msgs.RegionOfInterest.height)
}
...
inline uint32_t RegionOfInterest::width() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.RegionOfInterest.width)
...
inline void RegionOfInterest::set_width(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:sensor_msgs.RegionOfInterest.width)
}
...
inline bool RegionOfInterest::do_rectify() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.RegionOfInterest.do_rectify)
...
inline void RegionOfInterest::set_do_rectify(bool value) {
  ...
  // @@protoc_insertion_point(field_set:sensor_msgs.RegionOfInterest.do_rectify)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_sensor_5fmsgs_2fregion_5fof_5finterest_2eproto
