...
#ifndef GOOGLE_PROTOBUF_INCLUDED_sensor_5fmsgs_2fimage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_sensor_5fmsgs_2fimage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_sensor_5fmsgs_2fimage_2eproto
...
struct TableStruct_sensor_5fmsgs_2fimage_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sensor_5fmsgs_2fimage_2eproto;
...
class Image final :
 ...
 public:
  ...
  uint32_t is_bigendian() const;
  void set_is_bigendian(uint32_t value);
  private:
  uint32_t _internal_is_bigendian() const;
  void _internal_set_is_bigendian(uint32_t value);
  public:
 ...
 private:
  ...
  uint32_t height_;
  uint32_t width_;
  uint32_t is_bigendian_;
  uint32_t step_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_sensor_5fmsgs_2fimage_2eproto;
};
// ===================================================================
...
inline void Image::unsafe_arena_set_allocated_header(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sensor_msgs.Image.header)
}
...
inline ::std_msgs::Header* Image::unsafe_arena_release_header() {
...
inline uint32_t Image::_internal_is_bigendian() const {
  return is_bigendian_;
}
inline uint32_t Image::is_bigendian() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.Image.is_bigendian)
  return _internal_is_bigendian();
}
inline void Image::_internal_set_is_bigendian(uint32_t value) {
  
  is_bigendian_ = value;
}
inline void Image::set_is_bigendian(uint32_t value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_sensor_5fmsgs_2fimage_2eproto
