...
#ifndef GOOGLE_PROTOBUF_INCLUDED_std_5fmsgs_2fcolor_5frgba_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_std_5fmsgs_2fcolor_5frgba_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_std_5fmsgs_2fcolor_5frgba_2eproto
...
struct TableStruct_std_5fmsgs_2fcolor_5frgba_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_std_5fmsgs_2fcolor_5frgba_2eproto;
namespace std_msgs {
class ColorRGBA;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::std_msgs::ColorRGBA* Arena::CreateMaybeMessage<::std_msgs::ColorRGBA>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace std_msgs {
...
class ColorRGBA final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:std_msgs.ColorRGBA) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:std_msgs.ColorRGBA)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_std_5fmsgs_2fcolor_5frgba_2eproto;
};
// ===================================================================
...
inline float ColorRGBA::r() const {
  // @@protoc_insertion_point(field_get:std_msgs.ColorRGBA.r)
  return _internal_r();
}
...
inline void ColorRGBA::set_r(float value) {
  ...
  // @@protoc_insertion_point(field_set:std_msgs.ColorRGBA.r)
}
...
inline float ColorRGBA::g() const {
  // @@protoc_insertion_point(field_get:std_msgs.ColorRGBA.g)
  return _internal_g();
}
...
inline void ColorRGBA::set_g(float value) {
  ...
  // @@protoc_insertion_point(field_set:std_msgs.ColorRGBA.g)
}
...
inline float ColorRGBA::b() const {
  // @@protoc_insertion_point(field_get:std_msgs.ColorRGBA.b)
  return _internal_b();
}
...
inline void ColorRGBA::set_b(float value) {
  ...
  // @@protoc_insertion_point(field_set:std_msgs.ColorRGBA.b)
}
...
inline float ColorRGBA::a() const {
  // @@protoc_insertion_point(field_get:std_msgs.ColorRGBA.a)
  return _internal_a();
}
...
inline void ColorRGBA::set_a(float value) {
  ...
  // @@protoc_insertion_point(field_set:std_msgs.ColorRGBA.a)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_std_5fmsgs_2fcolor_5frgba_2eproto
