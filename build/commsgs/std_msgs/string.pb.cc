...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_std_5fmsgs_2fstring_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_std_5fmsgs_2fstring_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_std_5fmsgs_2fstring_2eproto = nullptr;

const uint32_t TableStruct_std_5fmsgs_2fstring_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_std_5fmsgs_2fstring_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\025std_msgs/string.proto\022\010std_msgs\"\026\n\006Str"
  "ing\022\014\n\004data\030\001 \001(\tb\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_std_5fmsgs_2fstring_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_std_5fmsgs_2fstring_2eproto = {
  false, false, 65, descriptor_table_protodef_std_5fmsgs_2fstring_2eproto, "std_msgs/string.proto", 
  &descriptor_table_std_5fmsgs_2fstring_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_std_5fmsgs_2fstring_2eproto::offsets,
  file_level_metadata_std_5fmsgs_2fstring_2eproto, file_level_enum_descriptors_std_5fmsgs_2fstring_2eproto, file_level_service_descriptors_std_5fmsgs_2fstring_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_std_5fmsgs_2fstring_2eproto_getter() {
  return &descriptor_table_std_5fmsgs_2fstring_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_std_5fmsgs_2fstring_2eproto(&descriptor_table_std_5fmsgs_2fstring_2eproto);
namespace std_msgs {
...
String::String(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:std_msgs.String)
}
...
::PROTOBUF_NAMESPACE_ID::Metadata String::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_std_5fmsgs_2fstring_2eproto_getter, &descriptor_table_std_5fmsgs_2fstring_2eproto_once,
      file_level_metadata_std_5fmsgs_2fstring_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::std_msgs::String* Arena::CreateMaybeMessage< ::std_msgs::String >(Arena* arena) {
  return Arena::CreateMessageInternal< ::std_msgs::String >(arena);
}
