...
#ifndef GOOGLE_PROTOBUF_INCLUDED_std_5fmsgs_2fmulti_5farray_5fdimension_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_std_5fmsgs_2fmulti_5farray_5fdimension_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_std_5fmsgs_2fmulti_5farray_5fdimension_2eproto
...
struct TableStruct_std_5fmsgs_2fmulti_5farray_5fdimension_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_std_5fmsgs_2fmulti_5farray_5fdimension_2eproto;
namespace std_msgs {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::std_msgs::MultiArrayDimension* Arena::CreateMaybeMessage<::std_msgs::MultiArrayDimension>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace std_msgs {
...
class MultiArrayDimension final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:std_msgs.MultiArrayDimension) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:std_msgs.MultiArrayDimension)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_std_5fmsgs_2fmulti_5farray_5fdimension_2eproto;
};
// ===================================================================
...
inline const std::string& MultiArrayDimension::label() const {
  // @@protoc_insertion_point(field_get:std_msgs.MultiArrayDimension.label)
...
void MultiArrayDimension::set_label(ArgT0&& arg0, ArgT... args) {
 ...
 label_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:std_msgs.MultiArrayDimension.label)
}
inline std::string* MultiArrayDimension::mutable_label() {
  std::string* _s = _internal_mutable_label();
  // @@protoc_insertion_point(field_mutable:std_msgs.MultiArrayDimension.label)
  return _s;
}
...
inline std::string* MultiArrayDimension::release_label() {
  // @@protoc_insertion_point(field_release:std_msgs.MultiArrayDimension.label)
...
inline void MultiArrayDimension::set_allocated_label(std::string* label) {
  ...
  // @@protoc_insertion_point(field_set_allocated:std_msgs.MultiArrayDimension.label)
}
...
inline uint32_t MultiArrayDimension::size() const {
  // @@protoc_insertion_point(field_get:std_msgs.MultiArrayDimension.size)
...
inline void MultiArrayDimension::set_size(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:std_msgs.MultiArrayDimension.size)
}
...
inline uint32_t MultiArrayDimension::stride() const {
  // @@protoc_insertion_point(field_get:std_msgs.MultiArrayDimension.stride)
...
inline void MultiArrayDimension::set_stride(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:std_msgs.MultiArrayDimension.stride)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_std_5fmsgs_2fmulti_5farray_5fdimension_2eproto
