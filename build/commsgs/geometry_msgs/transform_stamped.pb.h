...
#ifndef GOOGLE_PROTOBUF_INCLUDED_geometry_5fmsgs_2ftransform_5fstamped_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_geometry_5fmsgs_2ftransform_5fstamped_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_geometry_5fmsgs_2ftransform_5fstamped_2eproto
...
struct TableStruct_geometry_5fmsgs_2ftransform_5fstamped_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_geometry_5fmsgs_2ftransform_5fstamped_2eproto;
...
class TransformStamped final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:geometry_msgs.TransformStamped) */ {
 public:
  ...
  PROTOBUF_NODISCARD ::geometry_msgs::Transform* release_transform();
  ...
  ::geometry_msgs::Transform* _internal_mutable_transform();
  public:
  void unsafe_arena_set_allocated_transform(
      ::geometry_msgs::Transform* transform);
  ::geometry_msgs::Transform* unsafe_arena_release_transform();
 ...
 private:
  ...
  friend struct ::TableStruct_geometry_5fmsgs_2ftransform_5fstamped_2eproto;
};
// ===================================================================
...
inline void TransformStamped::unsafe_arena_set_allocated_header(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:geometry_msgs.TransformStamped.header)
}
...
inline ::std_msgs::Header* TransformStamped::unsafe_arena_release_header() {
...
inline ::std_msgs::Header* TransformStamped::_internal_mutable_header() {
...
inline const std::string& TransformStamped::child_frame_id() const {
  // @@protoc_insertion_point(field_get:geometry_msgs.TransformStamped.child_frame_id)
...
void TransformStamped::set_child_frame_id(ArgT0&& arg0, ArgT... args) {
 ...
 child_frame_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:geometry_msgs.TransformStamped.child_frame_id)
}
inline std::string* TransformStamped::mutable_child_frame_id() {
  std::string* _s = _internal_mutable_child_frame_id();
  // @@protoc_insertion_point(field_mutable:geometry_msgs.TransformStamped.child_frame_id)
  return _s;
}
...
inline std::string* TransformStamped::release_child_frame_id() {
  // @@protoc_insertion_point(field_release:geometry_msgs.TransformStamped.child_frame_id)
...
inline void TransformStamped::set_allocated_child_frame_id(std::string* child_frame_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:geometry_msgs.TransformStamped.child_frame_id)
}
...
inline const ::geometry_msgs::Transform& TransformStamped::_internal_transform() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::geometry_msgs::Transform&>(
...
inline void TransformStamped::unsafe_arena_set_allocated_transform(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:geometry_msgs.TransformStamped.transform)
}
...
inline ::geometry_msgs::Transform* TransformStamped::unsafe_arena_release_transform() {
...
inline ::geometry_msgs::Transform* TransformStamped::_internal_mutable_transform() {
  
  if (transform_ == nullptr) {
    auto* p = CreateMaybeMessage<::geometry_msgs::Transform>(GetArenaForAllocation());
    transform_ = p;
  }
  return transform_;
}
inline ::geometry_msgs::Transform* TransformStamped::mutable_transform() {
  ::geometry_msgs::Transform* _msg = _internal_mutable_transform();
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_geometry_5fmsgs_2ftransform_5fstamped_2eproto
